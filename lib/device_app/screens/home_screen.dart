                ...
                children: [
                  ...
                  DropdownButton<int>(
                    ...
                    items: const [
                      DropdownMenuItem(
                        value: 0,
                        child: Text('No Limit (Disabled)'),
                      ),
                      DropdownMenuItem(
                        value: 1,
                        child: Text('1 Minute (For Testing)'),
                      ),
              ...
              content: Column(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    subtitle: Text(
                      'Shows countdown overlay on launch',
                      style: TextStyle(
          ...
          children: [
            ...
            GestureDetector(
              onVerticalDragUpdate: (details) {
                double newFraction =
                    controller.drawerHeightFraction.value -
                    (details.primaryDelta! / screenHeight);
                controller.drawerHeightFraction.value = newFraction.clamp(
                  0.0,
                  1.0,
                );
              },
              onVerticalDragEnd: (details) {
                if (controller.drawerHeightFraction.value > 0.4 ||
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () => Get.to(() => const PauseScreen()),
                          ),
                          IconButton(
                            icon: const Icon(
                              Icons.alarm_rounded,
                      ...
                      return Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final hasLimit = controller.limitsMap.containsKey(
                              app.packageName,
                            );
                            ...
                            return GestureDetector(
                              ...
                              onLongPress:
                                  () =>
                                      _showAppOptions(context, app, controller),
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Stack(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          _buildDockIcon(
                            ...
                            onTap:
                                () =>
                                    controller.launchApp('com.android.dialer'),
                          ),
            ...
            Obx(() {
              final drawerY =
                  screenHeight -
                  (controller.drawerHeightFraction.value * screenHeight);
              return Positioned(
                left: 0,
                right: 0,
                top: drawerY,
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    color: Color(
                      0xFA12111A,
                    ), // Frosted/dark semi-opaque background
                      ...
                      GestureDetector(
                        onVerticalDragUpdate: (details) {
                          double newFraction =
                              controller.drawerHeightFraction.value -
                              (details.primaryDelta! / screenHeight);
                          controller.drawerHeightFraction.value = newFraction
                              .clamp(0.0, 1.0);
                        },
                        onVerticalDragEnd: (details) {
                          if (controller.drawerHeightFraction.value < 0.8 &&
                              details.primaryVelocity! > 300) {
                            controller.drawerHeightFraction.value = 0.0;
                            controller.isDrawerOpen.value = false;
                            FocusScope.of(context).unfocus();
