...
class DeleteWebsitesBlockingScreen extends StatefulWidget {
  const DeleteWebsitesBlockingScreen({super.key});

  @override
  State<DeleteWebsitesBlockingScreen> createState() => _DeleteWebsitesBlockingScreenState();
}

class _DeleteWebsitesBlockingScreenState extends State<DeleteWebsitesBlockingScreen> {
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            await AppDbHelper.instance.deleteBlockedWebsites(idsToDelete);
                            if (ctx.mounted) {
                              Navigator.pop(ctx);
                            }
                            if (mounted) {
